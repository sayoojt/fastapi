...
[![codecov](https://codecov.io/gh/sayoojt/fastapi/branch/main/graph/badge.svg?token=fastapi_token_here)](https://codecov.io/gh/sayoojt/fastapi)
[![CI](https://github.com/sayoojt/fastapi/actions/workflows/main.yml/badge.svg)](https://github.com/sayoojt/fastapi/actions/workflows/main.yml)

Awesome fastapi created by sayoojt

## Install

from source
```bash
git clone https://github.com/sayoojt/fastapi fastapi
cd fastapi
make install
```
